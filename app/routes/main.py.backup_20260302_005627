...
def _get_dashboard_endpoint(tipo):
    """Retorna endpoint do dashboard baseado no tipo de utilizador."""
    endpoints = {
...
def baixar_fatura(trans_id):
    ...
    # 6. CONFIGURAÇÃO CRÍTICA: Caminho do wkhtmltopdf
    # Usa configuração da aplicação ou fallback para PATH do sistema
